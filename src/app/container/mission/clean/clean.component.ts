...
export class CleanComponent implements OnInit {
    ...
    if (this.missionId) {
      ...
      await this.missionService.getJoinBy(query).subscribe(
        result => {
          ...
          if (this.missionDetail.cleandate) {
            this.missionDetail.cleandate = {
              date: {
                year: moment(this.missionDetail.cleandate).format('YYYY'),
                month: moment(this.missionDetail.cleandate).format('MM'),
                day: moment(this.missionDetail.cleandate).format('D'),
              }
            }
          }
  ...
  public async saveMissionDetail() {
    ...
    const body = {
      ...
      cleanplace: this.missionDetail.cleanplace,
      cleandate: this.missionDetail.cleandate ? this.missionDetail.cleandate.formatted : null,
      status: '已提交',
      experience: exp,
      picture: './assets/activity/h4.jpg;./assets/activity/h5.jpg',
